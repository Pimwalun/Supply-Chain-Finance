...
const wallet = new FileSystemWallet('../identity/user/issuingbank/wallet');
...
async function main() {
    ...
    try {
        ...
        const paidResponse = await contract.submitTransaction('paid', 'IssuingBank', '00001', 'AdvisoringBank', 'IssuingBank', '999999', '2019-20-02');
...
main().then(() => {
    ...
    console.log('Paid program complete.');

}).catch((e) => {

    console.log('Paid program exception.');
    console.log(e);
    console.log(e.stack);
    process.exit(-1);
