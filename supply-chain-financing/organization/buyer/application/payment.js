...
async function main() {
  ...
  try {
    ...
    const paymentResponse = await contract.submitTransaction('payment', 'buyer', '00001', 'buyer','funder','300000','2019-20-02' );
...
main().then(() => {
  ...
  console.log('Payment program complete.');

}).catch((e) => {

  console.log('Payment program exception.');
  console.log(e);
  console.log(e.stack);
  process.exit(-1);
